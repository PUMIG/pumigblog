...
import { getFirestore, collection, doc, setDoc, deleteDoc, getDoc } from "https://cdnjs.cloudflare.com/ajax/libs/firebase/9.22.1/firebase-firestore.js";
  ...
  if(usersDocSnap.data().state == "normal") {
  ...
  if(castToposting != null) {
    ...
    var postContentSpace = document.getElementById("blogPost");
    var postContentTag = postContentSpace.getElementsByTagName("p");
    ...
    postContentTag[1].innerHTML = castToposting.content;
  ...
  submitBtn.addEventListener('click', async function() {
    ...
    var postContentSpace = document.getElementById("blogPost");
    var postContentTag = postContentSpace.getElementsByTagName("p");
    var postContent = postContentTag[1].innerHTML;
